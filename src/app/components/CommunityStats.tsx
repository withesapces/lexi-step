        ...
        <div className="flex flex-col md:flex-row items-stretch justify-between gap-8">
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl font-black mb-6">
              <span className="bg-yellow-300 text-black px-4 py-2 inline-block transform -rotate-3" style={{boxShadow: "5px 5px 0 rgba(255,255,255,0.5)"}}>
                STATS COMMUNAUTÉ
              </span>
            </h2>
            ...
            <div className="flex flex-col gap-3 mb-6">
              <div className="flex justify-between bg-white bg-opacity-10 p-4 border-l-4 border-yellow-300 transform -rotate-1">
                ...
                <span className="font-black text-xl text-yellow-300">{stats.wordsToday.toLocaleString()}</span>
              </div>
              <div className="flex justify-between bg-white bg-opacity-10 p-4 border-l-4 border-yellow-300 transform rotate-1">
                <span className="font-bold text-lg">Membres en streak (7+ jours):</span>
                <span className="font-black text-xl text-yellow-300">{stats.streakingMembers}</span>
              </div>
              <div className="flex justify-between bg-white bg-opacity-10 p-4 border-l-4 border-yellow-300 transform -rotate-1">
                <span className="font-bold text-lg">Écrivains en ligne:</span>
                <span className="font-black text-xl text-yellow-300">{stats.onlineWriters}</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 bg-yellow-300 text-black p-6 border-4 border-white transform rotate-2" 
            ...
            <h3 className="text-2xl font-black mb-4 bg-black text-white inline-block px-3 py-1 transform -rotate-2">RAPPEL NEUROSCIENTIFIQUE 🧠</h3>
            <p className="font-bold mb-4 text-lg">Écrire 200-1000 mots quotidiennement pendant 30 jours consécutifs améliore:</p>
