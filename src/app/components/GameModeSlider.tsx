...
export default function GameModeSlider({
    ...
    useEffect(() => {
        ...
        // If initialMode is provided, find its index
        if (initialMode) {
                        ...
                        {gameModes.map((mode, index) => (
                            ...
                            >
                                <motion.div
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className={`w-full h-full ${mode.bgColor} mx-auto flex flex-col justify-between relative overflow-hidden transition-all duration-300`}
                                    style={{
                                        borderRadius: "8px",
                    ...
                    <div className="bg-black inline-flex p-2 rounded-full transform rotate-1">
                        {gameModes.map((_, index) => (
                            <button
                                ...
                                className={`w-5 h-5 mx-1 rounded-full border-2 border-black transition-all transform hover:scale-110 ${activeSlide === index
